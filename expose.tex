...
\begin{frame}
  ...
  \item Geometrical setting: compact, complex, symplectic manifold $M$
    under compatibility conditions; complex line bundle $L$ over $M$.
...
\footnotesize{[3] Woodhouse, Geometric Quantization. Oxford University Press, 1997.}
\end{frame}
...
\begin{frame}
  ...
  \begin{minipage}[l]{0.3\linewidth}\vspace{1em}
    ...
    \uncover<2>{\begin{center}\includegraphics[width=0.7\linewidth]{35.png}\end{center}}
  \end{minipage}
